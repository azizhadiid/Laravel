...
<body class="bg-amber-50 flex items-center justify-center h-screen font-serif">
    ...
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md border-t-4 border-amber-700">
        <h2 class="text-2xl font-bold mb-6 text-amber-900">Tambah Buku Baru</h2>
        ...
        <form action="{{ route('books.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" class="w-full border-b-2 border-gray-300 focus:border-amber-600 outline-none py-2 transition" required>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-1">Penulis</label>
                <input type="text" name="author" class="w-full border-b-2 border-gray-300 focus:border-amber-600 outline-none py-2 transition" required>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-1">Tahun Terbit</label>
                <input type="number" name="year" class="w-full border-b-2 border-gray-300 focus:border-amber-600 outline-none py-2 transition" required>
            </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="flex-1 bg-amber-700 hover:bg-amber-900 text-white font-bold py-2 rounded">Simpan</button>
